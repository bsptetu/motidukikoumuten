...
(function() {
	...
	Graphics.printLink2 = function(url, title) {
		if (window.RPGAtsumaru && window.RPGAtsumaru.popups && window.RPGAtsumaru.popups.openLink) {
			...
			var link = '<a href="tel:+81-54-622-4929"><img src="tel_banner.jpg" alt="電話でのお問合せ　☎054-622-4929 スマートフォンをご利用の場合、こちらをタップすることで電話をかけることができます" style="color:#000000;font-size: 5vw;background-color: #c8e0a4;text-decoration: none;position: absolute;top: 260%;left: 5%;height: 12vh;" rel="noopener"></a>';
